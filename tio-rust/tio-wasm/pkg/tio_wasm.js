...
* @returns {any}
*/
export function raw_packet_from_bytes(bytes) {
    var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.raw_packet_from_bytes(ptr0, len0);
...
* @returns {any}
*/
export function floats_from_raw_stream_packet(val) {
    var ret = wasm.floats_from_raw_stream_packet(addHeapObject(val));
    return takeObject(ret);
}
...
* @returns {any}
*/
export function simple_rpc_request_as_bytes(name) {
    var ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.simple_rpc_request_as_bytes(ptr0, len0);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function simple_rpc_request(name) {
    var ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.simple_rpc_request(ptr0, len0);
    return takeObject(ret);
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('tio_wasm_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_get_4a06995f204d5c61 = function() { return handleError(function (arg0, arg1) {
